...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="panel_jurado.php">
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-4">
          <a href="resultadosindividuales.php" class="nav-link">
        ...
        <div class="col-4">
          <a href="resultadosglobales.php" class="nav-link">
        ...
        <!-- Tarjeta 4: Fondos asignados -->
        <div class="col-4">
          <a href="resultadosfondos.php" class="nav-link">
            <div class="card info-card revenue-card">
              <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3">
                    ...
                    <span class="text-muted small pt-2 ps-1"> | Beneficios</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <!-- Tarjeta 5: Perfil -->
        <div class="col-4">
          <a href="users-profile.php" class="nav-link">
            <div class="card info-card sales-card">
              <div class="card-body">
        ...
        <!-- Tarjeta 6: Manual -->
        <div class="col-4">
          <a href="manual_jurado.php" class="nav-link">
            <div class="card info-card revenue-card">
              <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3">
                    ...
                    <span class="text-muted small pt-2 ps-1"> | Guía de uso</span>
                  </div>
                </div>
              </div>
            </div>
