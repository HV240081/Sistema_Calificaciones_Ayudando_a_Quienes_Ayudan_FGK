...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  // Verificar si el proyecto ya ha sido calificado por cualquier usuario
    $sql = "SELECT COUNT(*) FROM CALIFICACION WHERE ID_PROYECTO = :ID_PROYECTO";
    $stmt = $pdo->prepare($sql);
    ...
    if ($alreadyRated > 0) {
        // Si el proyecto ya fue calificado, redirigir y mostrar mensaje de error
