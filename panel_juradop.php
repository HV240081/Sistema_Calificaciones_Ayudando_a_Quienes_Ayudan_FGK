  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Panel Jurado</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <!-- Tarjeta 2: Resultados Individuales -->
        <div class="col-4">
          <a href="resultadosindividualesp.php" class="nav-link">
            <div class="card info-card revenue-card">
              <div class="card-body">
                <h5 class="card-title">Resultados Individuales</h5>
                <div class="d-flex align-items-center">
                  <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                    <i class="bi bi-person"></i>
                  </div>
                  <div class="ps-3">
                    <span class="text-success small pt-1 fw-bold">Participantes</span>
                    <span class="text-muted small pt-2 ps-1"> | Puntajes</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <!-- Tarjeta 3: Resultados Globales -->
        <div class="col-4">
          <a href="resultadosglobalesp.php" class="nav-link">
            <div class="card info-card sales-card">
              <div class="card-body">
                <h5 class="card-title">Resultados Globales</h5>
                <div class="d-flex align-items-center">
                  <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                    <i class="bi bi-bar-chart"></i>
                  </div>
                  <div class="ps-3">
                    <span class="text-success small pt-1 fw-bold">Competencia</span>
                    <span class="text-muted small pt-2 ps-1"> | Ranking</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <!-- Tarjeta 4: Asignar fondos -->
        <div class="col-4">
          <a href="fondos.php" class="nav-link">
            <div class="card info-card revenue-card">
              <div class="card-body">
                <h5 class="card-title">Asignar fondos</h5>
                <div class="d-flex align-items-center">
                  <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                    <i class="bi bi-cash-stack"></i>
                  </div>
                  <div class="ps-3">
                    <span class="text-success small pt-1 fw-bold">Asignar fondos</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <!-- Tarjeta 5: Fondos asignados -->
        <div class="col-4">
          <a href="resultadosfondosp.php" class="nav-link">
            <div class="card info-card sales-card">
              <div class="card-body">
                <h5 class="card-title">Fondos asignados</h5>
                <div class="d-flex align-items-center">
                  <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                    <i class="bi bi-gem"></i>
                  </div>
                  <div class="ps-3">
                    <span class="text-success small pt-1 fw-bold">Fondos asignados</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <!-- Tarjeta 5: Perfil -->
        <div class="col-4">
          <a href="user-profilep.php" class="nav-link">
            <div class="card info-card revenue-card">
              <div class="card-body">
        ...
        <!-- Tarjeta 6: Manual -->
        <div class="col-4">
          <a href="manual_juradop.php" class="nav-link">
            <div class="card info-card sales-card">
              <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ps-3">
                    ...
                    <span class="text-muted small pt-2 ps-1"> | Jurado</span>
                  </div>
                </div>
              </div>
            </div>
