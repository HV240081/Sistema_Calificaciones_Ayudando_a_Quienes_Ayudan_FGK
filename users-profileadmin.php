...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="users-profileadmin.php">
                    <i class="bi bi-person"></i>
                    <span>Perfil</span>
                </a>
            </li><!-- End Profile Page Nav -->
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <button class="btn btn-primary action-btn" onclick="window.location.href='panel_admin.php'">Volver al Panel</button>
