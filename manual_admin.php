                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="embed-responsive embed-responsive-16by9">
                        <iframe src="manuales/manual_administrador.pdf" class="embed-responsive-item" width="100%"
                          height="500px"></iframe>
                      </div>

                      <!-- Botón de descarga -->
                      <div class="mt-3">
                        <a href="manuales/manual_administrador.pdf" download class="btn btn-primary" target="_blank">
