...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="manual_admin.php">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Manual Administrador</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="container mt-4">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <h5 class="card-title">Manual de Administrador</h5>
                      <!-- Previsualización del PDF -->
                      <div class="embed-responsive embed-responsive-16by9">
                        <iframe src="./manuales/manual_administrador.pdf?<?php echo time(); ?>" class="embed-responsive-item" width="100%"
                          height="500px"></iframe>
                      </div>

                      <!-- Botón de descarga -->
                      <div class="mt-3">
                        <a href="./manuales/manual_administrador.pdf?<?php echo time(); ?>" download class="btn btn-primary" target="_blank">
